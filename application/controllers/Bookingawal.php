...
{ 
    ...
    { 
        ...
        if ($dtb < 1) {
            $this->session->set_flashdata('pesan', '<div class="alert alert-massege alert-danger" role="alert">Tidak Ada Data Booking. Pastikan Anda Booking Salah Satu Buku Yang Ada</div>'); 
            redirect(base_url()); 
        } else { 
